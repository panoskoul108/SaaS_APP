...
// --- ΛΕΞΙΚΟ ΓΙΑ ΤΗ ΣΕΛΙΔΑ ΤΗΣ ΠΑΡΑΓΓΕΛΙΑΣ ΚΑΙ ΤΗΝ ΑΞΙΟΛΟΓΗΣΗ ---
const DICT = {
  gr: {
...
export default function OrderStatus({
  ...
  const t = DICT[lang] || DICT.gr; // Ενεργοποίηση της σωστής γλώσσας
  ...
  // Βοηθητική συνάρτηση για δυναμική μετάφραση προϊόντων στην οθόνη ανασκόπησης
